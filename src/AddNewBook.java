...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        ...
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("I Y BTechCS");c4.addItem("II Y BTechCS");c4.addItem("III Y BTechCS");c4.addItem("IV Y BTechCS");
        }
        if(c3.getSelectedItem()=="Arts")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("I Y BA");c4.addItem("II Y BA");c4.addItem("III Y BA");
        }
        if(c3.getSelectedItem()=="Commerce")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("I Y BCom");c4.addItem("II Y BCom");c4.addItem("III Y BCom");
        }
    ...
    public void connect()
    {
        ...
        {  
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/library?useSSL=false&autoReconnect=true","root","");  
