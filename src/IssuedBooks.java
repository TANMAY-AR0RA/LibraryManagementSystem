...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        ...
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("I Y BTechCS");c2.addItem("II Y BTechCS");c2.addItem("III Y BTechCS");c2.addItem("IV Y BTechCS");
        }
        if(c1.getSelectedItem()=="Arts")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("I Y BA");c2.addItem("II Y BA");c2.addItem("III Y BA");
        }
        if(c1.getSelectedItem()=="Commerce")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("I Y BCom");c2.addItem("II Y BCom");c2.addItem("III Y BCom");
        }
    ...
    private void c2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c2ActionPerformed
        try
        {
            ...
            while(rs.next())
            {
            Object[] row = {rs.getString("student_id"),rs.getString("student_name"),rs.getString("book_id"),rs.getString("book_name"),rs.getString("address"),rs.getString("issue_date")};
            model.addRow(row);
            }
        }
        catch(Exception e)
